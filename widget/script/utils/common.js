    ...
    Common.prototype = {
        ...
        openWin: function (opts, normal) {
            ...
            if (normal) {
                ...
                if (opts.hideFooter) {
                    _g.setLS('hideFooter', opts.hideFooter);
                }
                api.openWin({
                    name: opts.name + '-win',
                    url: (function () {
        ...
        showAlert: function (opts) {
            ...
            dialogBox.alert({
                texts: {
                    title: '',
                    content: 'Login to view more  content',
                    leftBtnTitle: opts.leftBtnTitle || 'Sure',
                    rightBtnTitle: opts.leftBtnTitle || 'Cancels'
                },
                styles: {
                    bg: '#fff',
