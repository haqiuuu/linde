define(function (require, exports, module) {
    ...
    var main = new Vue({
        el: '#main',
        template: _g.getTemplate('account/forgetPassword_view'),
        data: {
            language: LANGUAGE,
            form: {
                email: '',
            ...
            validator: {
                email: function (value) {
                    if (!value) {
                        return LANGUAGE.account_forget_login_password_emailTip;
                ...
                code: function (value) {
                    if (!value) {
                        return LANGUAGE.account_forget_login_password_codeTip;
                    }
                    return true;
                },
                password: function (value) {
                    if (!value) {
                        return LANGUAGE.account_forget_login_password_passwordTip;
                    }
                ...
                confirmPassword: function (value) {
                    if (!value) {
                        return LANGUAGE.account_forget_login_password_againPasswordTip;
                    }
